...
ListBox::ListBox(const wxString& tittle)
    : wxFrame(nullptr, wxID_ANY, tittle, wxDefaultPosition, wxSize(360, 350)) {
        ...
        hbox->Add(btnPanel, 2, wxEXPAND | wxALL, 10);
        
        Connect(wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler(ListBox::OnDBClick));
...
MyPanel::MyPanel(wxPanel* parent)
        :wxPanel(parent, wxID_ANY)
        {
            ...
            ListBox* lb = (ListBox*) parent->GetParent();  //conversion seen again
            m_lb = lb->listbox;
