...
TextDrop::TextDrop(const wxString& tittle)
    :wxFrame(nullptr, wxID_ANY, tittle, wxDefaultPosition, wxSize(500,400))
    {
        ...
        m_gdir = new wxGenericDirCtrl(spl1, -1, wxT("/home/neutron/opengl/"),  wxPoint(-1, -1), wxSize(-1, -1), wxDIRCTRL_DIR_ONLY);
...
void TextDrop::OnSelect(wxCommandEvent& event)
{
    ...
    wxDir dir(path); //creating a dir object/variable
