// Chapter 16.2.5 Template Argument Deduction and References, 
// Exercise 16.42, p690
...
//      g(i * ci)   --  T is deduced as int  , val : const int&
//  (see example on page 687), clear!
//
// Exercise 16.45:
...
//
// when calling on a literal value, say 42. int&& && will collapse to int&&. At last
...
//The reason why int& can't be element of a vector can be found at:
//  http://stackoverflow.com/questions/922360/why-cant-i-make-a-vector-of-references
//in short, a int& variable must be initialized when it is declared.
