...
/*
//the spirit of template functions is seen.
//this template catches calls of all map types to display
...
void test1() {
    ...
    display(m);      //if template function is missing, no function to call error
